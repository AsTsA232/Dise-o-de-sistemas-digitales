...
HD_PWD='C:/Users/Admin/OneDrive/Documents/sistemas digitales/puntoflot/puntoflot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador_fin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador_fin.tcl -notrace
