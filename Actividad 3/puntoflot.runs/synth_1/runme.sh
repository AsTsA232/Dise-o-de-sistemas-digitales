...
HD_PWD='C:/Users/Admin/OneDrive/Documents/sistemas digitales/puntoflot/puntoflot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador_fin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador_fin.tcl
