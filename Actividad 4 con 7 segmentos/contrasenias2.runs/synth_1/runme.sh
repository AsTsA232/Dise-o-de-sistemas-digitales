...
HD_PWD='C:/Users/Admin/OneDrive/Documents/sistemas digitales/contrasenias2/contrasenias2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conts.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conts.tcl
