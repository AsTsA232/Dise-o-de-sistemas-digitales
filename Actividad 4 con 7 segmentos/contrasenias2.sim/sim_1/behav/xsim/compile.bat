...
REM
REM Generated by Vivado on Mon Oct 13 10:45:35 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj cont_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cont_tb_vlog.prj -log xvlog.log
