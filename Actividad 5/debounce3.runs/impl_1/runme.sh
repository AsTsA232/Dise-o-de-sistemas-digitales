...
HD_PWD='C:/Users/Admin/OneDrive/Documents/sistemas digitales/debounce3/debounce3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lvl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lvl.tcl -notrace
