...
REM
REM Generated by Vivado on Wed Oct 15 17:07:57 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj top_lvl_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj top_lvl_tb_vlog.prj -log xvlog.log
