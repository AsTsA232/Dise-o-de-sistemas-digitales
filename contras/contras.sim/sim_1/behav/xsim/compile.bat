...
REM
REM Generated by Vivado on Wed Sep 24 02:48:19 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj verifi_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj verifi_tb_vlog.prj -log xvlog.log
